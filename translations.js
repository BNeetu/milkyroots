const dict = [
  ...
  { sel: '#heroSlide .slide:nth-child(1) p', hi: 'भाटी फार्म्स फार्म पर हमारी स्वस्थ गायों को देखें।' },
  ...
  { sel: '#heroSlide .slide:nth-child(4) h4', hi: 'भाटी फार्म्स का झुंड' },
  ...
  { sel: '.policy-item:nth-child(6) p', hi: 'भाटी फार्म्स में, हम उच्चतम मानकों को सुनिश्चित करते हैं। यदि हमारा उत्पाद आपकी अपेक्षाओं पर खरा नहीं उतरता है, तो समीक्षा और समाधान के लिए हमारी टीम से संपर्क करें।' },

  // Why Us
  { sel: '#why .section-label', hi: 'हमारा वादा' },
  { sel: '#why .section-title', hi: 'भाटी फार्म्स को क्यों चुनें?' },
  ...
  { sel: '.why-item:nth-child(5) p', hi: 'ब्यावर में 300+ परिवार भाटी फार्म्स से जुड़ चुके हैं। हमारी पुनरावृत्ति ग्राहक दर 95% से ऊपर है।' },
  ...
  { sel: '.about-text p:nth-child(3)', hi: 'पॉलीहाउस ब्यावर में एक भरोसेमंद नाम बन गया। जिन परिवारों ने भाटी फार्म्स के उत्पादों का स्वाद चखा, वे इस अंतर को जानते थे — वह स्वाद, वह ताज़गी, वह शुद्धता जो केवल उस ज़मीन से आती है जिसे प्यार और सम्मान दिया जाता है।' },
  ...
  { sel: '.about-chapter:nth-child(2) h3', hi: 'हमारी देसी गायें — भाटी फार्म्स का दिल' },
  ...
  { sel: '.about-chapter:nth-child(3) p', hi: 'भाटी फार्म्स में, दूध की शुद्धता कोई मार्केटिंग दावा नहीं है — यह जीवन का एक तरीका है। दूध का हर बैच हमारे खेत से निकलने से पहले एक सख्त गुणवत्ता जांच से गुजरता है।' },
  ...
  { sel: '.about-chapter:nth-child(4) p', hi: 'भाटी फार्म्स सिर्फ एक डेयरी नहीं है — यह एक संपूर्ण फार्म पारिस्थितिकी तंत्र है जहां गाय, बछड़े, कृषि उत्पाद और पृथ्वी एक साथ पनपते हैं।' },
  ...
  { sel: '.about-highlight h3', hi: 'भाटी फार्म्स नंबरों में' },
  ...
  // Team
  { sel: '#team .section-label', hi: 'भाटी फार्म्स के पीछे के लोग' },
  ...
  { sel: '.compare-table th:nth-child(2)', hi: '<img src="images/bhatifarm-logo.png" alt="भाटी फार्म्स" style="width: 28px; height: 28px; vertical-align: middle; margin-right: 5px; object-fit: contain;">भाटी फार्म्स<br><small style="font-weight:400;font-size:.72rem">शुद्ध देसी दूध</small>' },
  ...
  { sel: '#faq .section-sub', hi: 'भाटी फार्म्स के बारे में आप जो कुछ भी जानना चाहते हैं — ईमानदारी से उत्तर दिया गया।' },
  ...
  { sel: '.faq-col:nth-child(1) .faq-item:nth-child(4) .faq-a', hi: 'हमारा बिलोना घी पारंपरिक तरीके से बनाया जाता है — सिर्फ 1 किलो घी बनाने में 25 लीटर शुद्ध देसी गाय का दूध लगता है। इसे हाथ से मथा जाता है, लकड़ी की आग पर धीमी आंच पर पकाया जाता है और इसमें कोई एडिटिव नहीं होता। आप असली, शुद्ध, प्राचीन विधि वाले देसी गाय के घी के लिए भुगतान कर रहे हैं — जैसा कि प्रकृति का इरादा था।' },
  ...
  { sel: '.offer-strip p', hi: 'आज ही भाटी फार्म्स से जुड़ें और हमारे वफादार ग्राहकों के लिए इन विशेष लाभों का आनंद लें' },
  ...
  { sel: '.contact-item:nth-child(2) p', hi: 'भाटी फार्म्स,<br>ब्यावर – 305 901, राजस्थान' },
  ...
  { sel: '.order-form button', hi: '<img src="images/bhatifarm-logo.png" alt="भाटी फार्म्स" style="width: 24px; height: 24px; vertical-align: middle; margin-right: 5px; object-fit: contain;"> WhatsApp पर ऑर्डर दें' },

  // Footer
  { sel: 'footer strong', hi: '<img src="images/bhatifarm-logo.png" alt="भाटी फार्म्स" style="width: 24px; height: 24px; vertical-align: middle; margin-right: 5px; object-fit: contain;">भाटी फार्म्स' },
  { sel: 'footer span', hi: 'ब्यावर में ❤️ के साथ निर्मित · © 2025 भाटी फार्म्स। सर्वाधिकार सुरक्षित।' }
];

let currentLang = localStorage.getItem('bhatiFarmsLang') || 'en';
...
window.toggleLanguage = function() {
  ...
  localStorage.setItem('bhatiFarmsLang', newLang);
