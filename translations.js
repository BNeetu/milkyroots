const dict = [
  ...
  { sel: '.hero-desc', hi: '100% शुद्ध A2 दूध, बिलोना घी और जैविक डेयरी उत्पाद — हर सुबह हमारे खेत से आपके परिवार तक ब्यावर में ताज़ा पहुँचाए जाते हैं।' },
  ...
  // Hero Slides
  { sel: '#heroSlide .slide:nth-child(1) .s-badge', hi: 'हमारा गौरव' },
  { sel: '#heroSlide .slide:nth-child(1) h4', hi: 'शुद्ध गिर गाय' },
  { sel: '#heroSlide .slide:nth-child(1) p', hi: 'हमारे पोषक तत्वों से भरपूर A2 दूध का स्रोत — देशी, स्वस्थ और खुशहाल।' },
  ...
  { sel: '#about .section-title', hi: 'भाटी परिवार की विरासत' },
  { sel: '#about .section-sub', hi: 'एक साधारण पॉलीहाउस से लेकर एक संपन्न शुद्ध डेयरी फार्म तक — यह जुनून, शुद्धता और प्राकृतिक, ईमानदार भोजन के प्रति भाटी परिवार की अटूट प्रतिबद्धता की कहानी है।' },
  ...
  { sel: '.about-text p:nth-child(4)', hi: 'इस सफलता से प्रेरित होकर और एक गहरे उद्देश्य के साथ, भाटी परिवार ने अपना अगला साहसिक कदम उठाया — <strong>मिल्कीरूट्स (MilkyRoots) स्थापित करना</strong>, एक शुद्ध देसी गाय का डेयरी फार्म। उन्होंने महसूस किया कि जो समग्र, रसायन-मुक्त दर्शन उन्होंने अपनी फसलों पर लागू किया है, वह उनके समुदाय में उपलब्ध दूध की गुणवत्ता को भी बदल सकता है। उन्होंने बेहतरीन स्वदेशी मवेशियों को लाकर शुरुआत की, यह सुनिश्चित करते हुए कि उनकी गाएं तनाव-मुक्त, खुली हवा वाले वातावरण में रहें, जहाँ उनका प्राकृतिक आहार—जो हरे रंजके और देसी बाजरे से भरपूर है—दूध की बेहतर गुणवत्ता में झलके।' },
  { sel: '.about-text p:nth-child(5)', hi: 'आज, मिल्कीरूट्स ब्यावर की सबसे भरोसेमंद शुद्ध डेयरी के रूप में खड़ा है — भाटी परिवार की जीवन भर की खेती की विरासत को आगे बढ़ाते हुए, समुदाय को प्रकृति के अनुसार भोजन कराने की गर्वित प्रतिबद्धता के साथ।' },
  ...
  { sel: '#team .section-title', hi: 'हमारा परिवार, हमारी ताकत' },
  { sel: '#team .section-sub', hi: 'मिल्कीरूट्स विश्वास, परंपरा और पारिवारिक मूल्यों पर बना है। उन लोगों से मिलें जो इसे संभव बनाते हैं — हर एक दिन।' },
  { sel: '.team-card:nth-child(1) .team-badge', hi: '👑 संस्थापक और मालिक' },
  { sel: '.team-card:nth-child(1) h3', hi: 'अर्जुन सिंह भाटी 👑' },
  { sel: '.team-card:nth-child(1) p', hi: 'मिल्कीरूट्स के पीछे के दूरदर्शी। अर्जुन सिंह भाटी ने इस डेयरी की शुरुआत एक मिशन के साथ की थी — ब्यावर के हर घर में 100% शुद्ध, मिलावट रहित गाय का दूध पहुँचाना।' },
  { sel: '.team-card:nth-child(2) .team-badge', hi: '🤝 सह-संस्थापक' },
  { sel: '.team-card:nth-child(2) h3', hi: 'लक्ष्मण सिंह भाटी 🚜' },
  { sel: '.team-card:nth-child(2) p', hi: 'दैनिक संचालन की रीढ़। लक्ष्मण सिंह भाटी यह सुनिश्चित करते हैं कि हर सुबह वितरित किया गया दूध ताजगी और शुद्धता के उच्चतम मानकों को पूरा करे।' },
  { sel: '.team-card:nth-child(3) .team-badge', hi: '🎓 मार्गदर्शक' },
  { sel: '.team-card:nth-child(3) h3', hi: 'डी एस भाटी 🎓' },
  { sel: '.team-card:nth-child(3) p', hi: 'मिल्कीरूट्स के मार्गदर्शक और मार्गदर्शक प्रकाश। डी एस भाटी रणनीतिक ज्ञान और अनुभव प्रदान करते हैं, टीम का मार्गदर्शन करते हैं।' },
...
window.updateLanguage = function(lang) {
  ...
  if (langToggleMobile) langToggleMobile.textContent = lang === 'en' ? 'भाषा: हिन्दी / EN' : 'Language: English / HI';
}
